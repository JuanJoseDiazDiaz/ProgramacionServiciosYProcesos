package org.example.Tema2.Tarea2.Act2_11_Hilosincdec.Act2_12.Parte_2;
...
class Puente2 {
    ...
    synchronized public boolean autorizacionPaso(Persona2 persona) {
        boolean result;

        if (this.peso + persona.getPeso() <= Puente2.PESO_MAXIMO && this.numPersonas < Puente2.MAX_PERSONAS_TOTAL
                && this.numPersonas < Puente2.MAX_PERSONAS_POR_LADO) {
            this.numPersonas++;
    ...
    synchronized public void terminaPaso(Persona2 persona) {
        this.peso -= persona.getPeso();
        this.numPersonas--;
    }
}

class Persona2 implements Runnable {
    private final Puente2 puente;
    ...
    Persona2(Puente2 puente, int peso, int tMinPaso, int tMaxPaso, String idP) {
        this.puente = puente;
        this.peso = peso;
...
public class PasoPorPuente2 {
    public static void main(String[] args) {
        final Puente2 puente = new Puente2();
        ...
        System.out.println(">>>>>>>>>>>> Comienza a pasar Personas.");
        Random r = new Random();
        int idPersona = 1;
        ...
        while (true) {
            ...
            Thread hiloPersona = new Thread(new Persona2(puente, pesoPersona, tMinPaso, tMaxPaso, "P" + idPersona));
            hiloPersona.start();
